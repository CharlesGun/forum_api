...
describe('DomainErrorTranslator', () => {
  it('should translate error correctly', () => {
    ...
    expect(DomainErrorTranslator.translate(new Error('GET_THREAD.NOT_CONTAIN_NEEDED_PROPERTY')))
      .toStrictEqual(new InvariantError('properti yang dibutuhkan tidak ada'));
    ...
    expect(DomainErrorTranslator.translate(new Error('GET_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION')))
      .toStrictEqual(new InvariantError('tipe data tidak sesuai'));
    expect(DomainErrorTranslator.translate(new Error('GET_REPLY.NOT_CONTAIN_NEEDED_PROPERTY')))
      .toStrictEqual(new InvariantError('properti yang dibutuhkan tidak ada'));
    expect(DomainErrorTranslator.translate(new Error('GET_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION')))
      .toStrictEqual(new InvariantError('tipe data tidak sesuai'));
  });
